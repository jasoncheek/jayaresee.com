...
const Home = (props) => {
  ...
  return (
    <>
      ...
      })(window,document,'script','dataLayer','UA-44641857-3');`}} />
      </Head>
      <noscript dangerouslySetInnerHTML={{__html: `<iframe src="https://www.googletagmanager.com/ns.html?id=UA-44641857-3" height="0" width="0" style="display:none;visibility:hidden;"></iframe>`}} />
      <Page>
